                ...
                if result:
                    ...
                    try:
                        ...
                        if email_sent:
                            ...
                            st.warning("⚠️ Account created but couldn't send verification email. Please check your email configuration.")
                            st.info("ℹ️ You may need to contact support for manual verification.")
                    except Exception as e:
                        st.warning(f"⚠️ Account created but couldn't send verification email. Error: {str(e)}")
                        st.info("ℹ️ Please contact support for manual verification.")
                else:
